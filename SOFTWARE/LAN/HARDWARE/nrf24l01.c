...
#define NRF24L01_CE_H (GPIOA->BSRR = GPIO_Pin_8)    // PB1
#define NRF24L01_CE_L  (GPIOA->BRR = GPIO_Pin_8)    // PB1
#define NRF24L01_IRQ   (GPIOB->IDR&GPIO_Pin_2)//IRQ主机数据输入 PB0
...
#define Set_NRF24L01_CE (GPIOA->BSRR = GPIO_Pin_8)  
#define Clr_NRF24L01_CE  (GPIOA->BRR = GPIO_Pin_8)  
#define READ_NRF24L01_IRQ   (GPIOB->IDR&GPIO_Pin_2)
...
void NRF24L01_Configuration(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8;          //NRF24L01  
